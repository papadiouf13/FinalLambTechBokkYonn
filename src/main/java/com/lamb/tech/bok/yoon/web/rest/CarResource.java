...
import com.lamb.tech.bok.yoon.repository.CarRepository;
...
/**
 * REST controller for managing {@link com.lamb.tech.bok.yoon.domain.Car}.
 */
@RestController
    ...
    public ResponseEntity<Car> partialUpdateCar(@PathVariable(value = "id", required = false) final Long id, @NotNull @RequestBody Car car)
        ...
        Optional<Car> result = carRepository
            ...
            .map(existingCar -> {
                ...
                if (car.getNumberOfAvailableSeats() != null) {
                    existingCar.setNumberOfAvailableSeats(car.getNumberOfAvailableSeats());
                }
                if (car.getIsActive() != null) {
                    existingCar.setIsActive(car.getIsActive());
                }
